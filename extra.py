...
from python.segmentation import process_dicom_zip
import glob
from flask_cors import CORS
from python.model_converter import convert_to_stl
...
def segmentation_service():
    ...
    if file and allowed_file(file.filename):
        ...
        output_files = process_dicom_zip(filepath, app.config['PROCESSED_FOLDER'])
...
def model_generator_service():
    ...
    if file and allowed_file(file.filename):
        ...
        model_file = convert_to_stl(filepath, app.config['PROCESSED_FOLDER'])
